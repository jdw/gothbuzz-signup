...
object Glob {
    ...
    init {
        ...
        val implementedEnvironmentVariables = setOf("GOTHBUZZ_PROPAGATOR", "GOTHBUZZ_WORKFLOW_EXEC", "GOTHBUZZ_PROJECT_ID", "GOTHBUZZ_GOOGLE_LOCATION_ID", "GOTHBUZZ_ENVIRONMENT_NAME", "GOTHBUZZ_BUCKET_NAME", "GOTHBUZZ_BUCKET_SA_KEY", "GOTHBUZZ_SENDGRID_API_KEY", "GOTHBUZZ_NO_REPLY", "GOTHBUZZ_VERIFICATION_CODE_LENGTH")
